        ...
        mAdapter.setOnMyItemClickListener(new FamousTeacherDetailAdapter.OnMyItemClickListener() {
            ...
            public void onClick(View view, int position) {
                ...
                if (!StringUtils.isEmpty(path)) {
                    Intent intent = new Intent(FamousTeacherDetailActivity.this, DoukeDetailActivity.class);
            ...
            public void onSubjectClick(View view, String tag, int position) {
                ...
                if ("Answer".equals(tag)) {
                    // 点击我要回答
                    Intent intent = new Intent(FamousTeacherDetailActivity.this, SubjectDetailActivity.class);
                    ...
                    Intent intent = new Intent(FamousTeacherDetailActivity.this, SubjectAllActivity.class);
...
//        mAdapter.notifyDataSetChanged();
    ...
    protected void initStatus() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {//4.4以下不支持状态栏变色
            ...
            int statusBarHeight = getStatusBarHeight(FamousTeacherDetailActivity.this);
            llCenterLayout.setAlpha(0f);
    ...
    private void getZhuanjiaInfoFromAPI() {
        Observable.create(new ObservableOnSubscribe<ArticleInfo>() {
            ...
            public void subscribe(@NonNull ObservableEmitter<ArticleInfo> e) throws Exception {
                ...
                ArticleInfo masterInfo = mService.getFamousTeacherFromAPI(zhuanjiaID);
                e.onNext(masterInfo);
                e.onComplete();
            }
    ...
    private void getRefreshDataList(final String masterID) {
        ...
        Observable.zip(observable1, observable2, observable3, new Function3<List<ArticleInfo>, List<ArticleInfo>, List<ArticleInfo>, List<ArticleInfo>>() {
            ...
            public List<ArticleInfo> apply(@NonNull List<ArticleInfo> data1, @NonNull List<ArticleInfo> data2, @NonNull List<ArticleInfo> data3) throws Exception {
                ...
                if (data1.size() > 0) {
                    dataList.add(new ArticleInfo("教学分享", ArticleInfo.SHOW_TYPE_DECORATION));
    ...
    void showShareDialog() {
        ...
        View popView = LayoutInflater.from(this).inflate(R.layout.alert_share_famous_teacher, null);
    ...
    private void initPopViewPayDetail(final String masterid, final String realPrice) {
        ...
        popPayDetail.setOnDismissListener(new PopupWindow.OnDismissListener() {
            ...
            public void onDismiss() {
                setBackgroundAlpha(FamousTeacherDetailActivity.this, 1f);
            }
        });
        ...
        tvReportProtocol.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(FamousTeacherDetailActivity.this, PayProtocolActivity.class);
                startActivity(intent);
            }
        });
