...
public class DiscussCommentActivity extends BaseActivity implements IViewComment, IViewintegral, IViewWXShare {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getCourseInfo(phoneNumber, unionid, courseID);
    }
    ...
    private void initDatas() {
        ...
        huifu = intent.getStringExtra("huifu");
        title = intent.getStringExtra("title");
        content = intent.getStringExtra("content");
        dianzanstatus = intent.getStringExtra("dianzanstatus");
        jiakestatus = intent.getStringExtra("jiakestatus");
...
//        mSmartRefreshLayout.setEnableOverScrollBounce(false);//设置是否启用越界回弹
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.bt_agree:
                ...
                break;
            case R.id.bt_share:
                wxSharePresenter.share(phoneNumber, unionid, title, content, "", 0);
                break;
        }
    }
            ...
            public void subscribe(final ObservableEmitter<CourseInfo> e) throws Exception {
                ...
                .subscribe(new Observer<CourseInfo>() {
                    ...
                    public void onNext(CourseInfo courseInfo) {
                        jiakestatus = courseInfo.getData().getJiakestatus();
